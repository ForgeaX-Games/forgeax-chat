# ForgeaX Studio — forgeax-chat

[English](./README.md) · [简体中文](./README.zh-CN.md) · [↑ studio](https://github.com/ForgeaX-Games/forgeax-studio)

The chat surface — the conversation panel where you talk to Forge and steer the studio. A studio UI app composed by packages/studio.
